...
│	Description:
│	neoHGT adated `urllib` instead of FTP
│	to solve the `EOFError` in the downloading phase.
│	==================================================
│	Authorship:
        ...
        for row in self.df.itertuples():
            ...
            if self.check_local_file(file):
                ...
                for i in range(self.retries):
                    try:
                        #============================================================
                        my_url = f'ftp://ftp.ncbi.nlm.nih.gov/genomes/all/{remote_dir}/{fname}'
                        print(my_url)
                        with closing(request.urlopen( my_url )) as r:
